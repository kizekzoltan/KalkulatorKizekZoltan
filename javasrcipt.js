function szamolasNegyzet() {  
    ...
    var negyzetTerulet = "A területe " + aOldal * aOldal + " cm2.";
...
function szamolasKor(){
    ...
    var korTerulet = "A területe " + (sugar*sugar) * pi + " cm2.";
...
function szamolasKocka(){
    var aOldal = document.getElementById("oldal").value;
    var kockaFelszin = "A kocka felszíne " + (aOldal*aOldal) * 6 + " cm2."; 
    document.getElementById("felszin").innerHTML = kockaFelszin;
    var kockaTerfogat = "A kocka térfogata " + aOldal*aOldal*aOldal + " cm3.";
...
function szamolasTeglatest(){
    ...
    var teglatestFelszin = "A téglatest felszíne " + 2 * (aOldal*bOldal+aOldal*cOldal+bOldal*cOldal) + " cm2.";
    document.getElementById("felszin").innerHTML = teglatestFelszin;
    var teglatestTerfogat = "A téglatest térfogata " + aOldal*bOldal*cOldal + " cm3.";
